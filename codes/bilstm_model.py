...
from tensorflow.keras.layers import LSTM, Dense, Dropout, Bidirectional Bidirectional(LSTM, Dense, Dropout
...
model = Sequential([
    Bidirectional(LSTM(64, activation='relu', return_sequences=True, input_shape=(sequence_length, X.shape[2])),
    Dropout(0.2),
